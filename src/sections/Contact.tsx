...
export default function Contact() {
  ...
  const inputCls =
    "w-full rounded-xl border border-slate-700 bg-slate-900/70 px-4 py-3 text-sm text-white placeholder:text-slate-500 outline-none transition focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/20";

  return (
    <section id="contact" className="relative bg-[#04110D] py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={
            <>
              Get Help in <span className="text-gradient-emerald">Minutes</span>, Not Hours
            </>
          }
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-5">
          <Reveal className="lg:col-span-2">
            <div className="grid h-full gap-4">
              <a
                href={SITE.phoneHref}
                className="group flex items-center gap-5 rounded-3xl border border-emerald-400/40 bg-emerald-400/10 p-6 transition hover:bg-emerald-400/20"
              >
                <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-emerald-400 text-slate-900">
                ...
                <span>
                  ...
                  <span className="block font-display text-2xl font-extrabold text-white group-hover:text-emerald-300">
                    {SITE.phone}
                  </span>
                </span>
              </a>
              <a
                href={SITE.emailHref}
                className="group flex items-center gap-5 rounded-3xl border border-slate-700/60 bg-slate-900/60 p-6 transition hover:border-emerald-400/40"
              >
                <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-slate-800 text-emerald-400">
                ...
                <span>
                  ...
                  <span className="block text-lg font-bold text-white group-hover:text-emerald-300">
                    {SITE.email}
                  </span>
                </span>
              </a>
          ...
          <Reveal delay={0.12} className="lg:col-span-3">
            ...
            >
              ...
              <button
                type="submit"
                className="mt-6 flex w-full items-center justify-center gap-2.5 rounded-2xl bg-emerald-400 px-8 py-4 text-base font-bold text-slate-900 transition hover:bg-emerald-300"
              >
