...
const WHATSAPP_URL = `https://wa.me/16826662966?text=${encodeURIComponent(
  "Hi, I need a locksmith."
)}`;
...
/**
 * Floating contact cluster, pinned to the bottom of the screen once scrolled:
